<?php
	...
	**/
	...
	function display_latest_tweets(
		...
		$twitter_wrap_open   = '<section class="content green-background"><div class="eighty-spacer"></div><div class="content-block">"<div class="twitter-feed-container">',
		$twitter_wrap_close  = '</div></div><div class="eighty-spacer"></div><div class="dotted-line"></div></section>',
		$tweet_wrap_open     = '<p class="home-tweet-tweet">',
		...
		$consumerkey         = "4M7MkRlQ1u8nXtzTE80e7iZIc";
		$consumersecret      = "TVh0M0x7kT4so0qYsnqq3wsIjAUKtWLmtdpdTMLlNiXP6Yn19w";
		$accesstoken         = "76591116-R8Gv1LnamC3X6fCwPrjFLOk2wBTaVTncpZGgiqv63";
		$accesstokensecret   = "BWqOPNUtGzSgIzxE1mWl8VCZ4v0uLXemKZsEiKWyXlfZ7";
	...
	display_latest_tweets('SteveEdgeDesign');
?>
